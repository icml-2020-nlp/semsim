...
def add_optimization_args(parser):
    ...
    group.add_argument('--loss-weight', default=100, type=int, metavar='N',
                       help='loss = loss - loss_weight * reward')
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--rewarderpath', type=str, default=None,
                       help='load rewarder from?')
    # fmt: on
    return group
